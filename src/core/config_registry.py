...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "DINGTALK_WEBHOOK_URL": {
        "title": "DingTalk Group Bot Webhook URL",
        "description": "DingTalk custom group bot webhook URL. This is separate from DingTalk App Key and Stream mode.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "DINGTALK_SECRET": {
        ...
        "description": "Optional SEC-prefixed signing secret for the DingTalk custom group bot.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
